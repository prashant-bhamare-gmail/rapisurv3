  ...
  _createClass(Mention, [
    ...
    },
    {
      ...
      value: function setupHTML() {
        ...
        this.html.input.parentElement.insertBefore(
          this.html.wrapper,
          this.html.input
        );
        ...
        if (this.reverse) {
          ...
          this.html.wrapper.insertBefore(
            this.html.optionsList,
            this.html.wrapper.firstChild
          );
        }
    ...
    },
    {
      ...
      value: function onEventOptionClick(optionEle) {
        var word =
          this.symbol +
          JSON.parse(optionEle.getAttribute('mentiondata')).name +
          ' ';
        var splitInputValue = this.html.input.value.split('');
        splitInputValue.splice(
          this.wordAtCursor.index,
          this.wordAtCursor.word.length,
          word
        );
    ...
    },
    {
      ...
      value: function cursorPositionChanged() {
        ...
        this.toggleOptionList(
          this.wordAtCursor.word.length &&
            this.wordAtCursor.word[0] == this.symbol
        );
    ...
    },
    {
      ...
      value: function showHideOptions() {
        for (var option in this.options) {
          ...
          if (this.startsWith(word, this.options[option]))
      ...
      value: function findMatches() {
        ...
        for (var index in inputValue) {
          ...
          var lastLetterIsSpace =
            ...
            lastLetter.charCodeAt(0) == 10;
          var canStartWord = letter == this.symbol && lastLetterIsSpace;

          if ((canStartWord || currentWord.length) && letter != ' ')
            currentWord += letter;
